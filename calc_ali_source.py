...
def calc_ALI_source(subject):
    ...
    ctl_right_rh = np.load(
        tf_folder +
        "%s_ctl_right_Brodmann.17-rh_MNE_source_power_snr_3.npy" %
        (subject))
    ctl_right_lh = np.load(
        tf_folder +
        "%s_ctl_right_Brodmann.17-lh_MNE_source_power_snr_3.npy" %
        (subject))
    ctl_left_rh = np.load(
        tf_folder + "%s_ctl_left_Brodmann.17-rh_MNE_source_power_snr_3.npy"
        % (subject))
    ctl_left_lh = np.load(
        tf_folder + "%s_ctl_left_Brodmann.17-lh_MNE_source_power_snr_3.npy"
        % (subject))

    ent_right_rh = np.load(
        tf_folder +
        "%s_ent_right_Brodmann.17-rh_MNE_source_power_snr_3.npy" %
        (subject))
    ent_right_lh = np.load(
        tf_folder +
        "%s_ent_right_Brodmann.17-lh_MNE_source_power_snr_3.npy" %
        (subject))
    ent_left_rh = np.load(
        tf_folder + "%s_ent_left_Brodmann.17-rh_MNE_source_power_snr_3.npy"
        % (subject))
    ent_left_lh = np.load(
        tf_folder + "%s_ent_left_Brodmann.17-lh_MNE_source_power_snr_3.npy"
        % (subject))
...
def calc_ALI_ITC_source(subject):
    ...
    ctl_right_rh = np.load(
        tf_folder +
        "%s_ctl_right_Brodmann.17-rh_MNE_source_itc_snr_3.npy" % (subject))
    ctl_right_lh = np.load(
        tf_folder +
        "%s_ctl_right_Brodmann.17-lh_MNE_source_itc_snr_3.npy" % (subject))
    ctl_left_rh = np.load(
        tf_folder + "%s_ctl_left_Brodmann.17-rh_MNE_source_itc_snr_3.npy" %
        (subject))
    ctl_left_lh = np.load(
        tf_folder + "%s_ctl_left_Brodmann.17-lh_MNE_source_itc_snr_3.npy" %
        (subject))

    ent_right_rh = np.load(
        tf_folder +
        "%s_ent_right_Brodmann.17-rh_MNE_source_itc_snr_3.npy" % (subject))
    ent_right_lh = np.load(
        tf_folder +
        "%s_ent_right_Brodmann.17-lh_MNE_source_itc_snr_3.npy" % (subject))
    ent_left_rh = np.load(
        tf_folder + "%s_ent_left_Brodmann.17-rh_MNE_source_itc_snr_3.npy" %
        (subject))
    ent_left_lh = np.load(
        tf_folder + "%s_ent_left_Brodmann.17-lh_MNE_source_itc_snr_3.npy" %
        (subject))
...
np.save(tf_folder + "%s_ali_itc_source_BA17.npy" % subject, data)
