...
###############################################################################
X_ctl_left = np.empty([len(subjects_select), 2001, 204])
X_ctl_right = np.empty([len(subjects_select), 2001, 204])
X_ent_left = np.empty([len(subjects_select), 2001, 204])
X_ent_right = np.empty([len(subjects_select), 2001, 204])
